...
Core memory file, contains class implementations for the underlying Memory component of the
memn2n model.
"""
import numpy as np
from nn import *
...
class MemoryBoW(Memory):
    """
    MemoryBoW:
        Query module  = Parallel((LookupTable + Sum(1)) + Identity) + MatVecProd with transpose +
        Softmax
