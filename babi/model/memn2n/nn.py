...
Core Neural Network file, containing class definitions for a series of Neural Layers.

References:
    https://github.com/facebook/MemNN/tree/master/MemN2N-babi-matlab/nn (Original FB Code)
    https://github.com/vinhkhuc/MemN2N-babi-python/blob/master/memn2n/nn.py (Vin Khuc's Python Code)
"""
